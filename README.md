...
- isolated margin
- SL ставится на стороне Bitget при открытии
...
## V15 PRO FIX — 40009 and real-position confirmation
...
- If any TP cannot be created after retry, already-created TP plans are cancelled and the bot attempts an emergency market close; the exchange-side SL remains the fallback.
